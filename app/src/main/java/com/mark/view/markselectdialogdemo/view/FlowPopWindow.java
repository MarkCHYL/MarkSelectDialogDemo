package com.mark.view.markselectdialogdemo.view;
...
import com.mark.view.markselectdialogdemo.adapter.FlowPopListViewAdapter;
...
public class FlowPopWindow extends PopupWindow {
    ...
    private final List<MarkSelectBean> dictList;
    ...
    public FlowPopWindow(Activity context, List<MarkSelectBean> dictList ) {
        ...
        tvReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*for (int x = 0; x < dictList.size(); x++) {
                    List<MarkItemChildBean> childrenBeen = dictList.get(x).getChildBeanList();
