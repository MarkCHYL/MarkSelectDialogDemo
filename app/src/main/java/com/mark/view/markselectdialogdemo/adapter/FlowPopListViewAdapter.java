package com.mark.view.markselectdialogdemo.adapter;
...
import com.mark.view.markselectdialogdemo.R;
...
import com.mark.view.markselectdialogdemo.view.SkuFlowLayout;
...
public class FlowPopListViewAdapter extends BaseAdapter {
    ...
    private List<MarkSelectBean> dictList;

    public FlowPopListViewAdapter(Activity context, List<MarkSelectBean> dictList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MarkSelectBean filtrateBean = dictList.get(position);
        vh.tvTypeName.setText(filtrateBean.getTypeName());

        setFlowLayoutData(filtrateBean.getChildBeanList(), vh.layoutProperty);

        return convertView;
    }

    private void setFlowLayoutData(final List<MarkItemChildBean> childrenList, final SkuFlowLayout flowLayout) {
...
//                    Toast.makeText(context,childrenList.get(finalX).getValue(),Toast.LENGTH_LONG).show();
    ...
    private void refreshCheckBox(SkuFlowLayout flowLayout, int finalX, List<MarkItemChildBean> propBeenList) {
